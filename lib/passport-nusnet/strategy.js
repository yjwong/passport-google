 ...
 *
 * The NUSNET authentication strategy authenticates requests by delegating to
 * NUSNET using the OpenID 2.0 protocol.
 *
 ...
 *
 * Options:
 *   - `returnURL`  URL to which NUSNET will redirect the user after authentication
